...
var reactNativeR1csfile = require('react-native-r1csfile');
var ejs = require('ejs');
...
async function r1csInfo(r1csName, logger) {
    ...
    const cir = await reactNativeR1csfile.readR1cs(r1csName);
...
async function r1csExportJson(r1csFileName, logger) {
    ...
    const cir = await reactNativeR1csfile.readR1cs(r1csFileName, true, true, true, logger);
...
async function newZKey(r1csName, ptauName, zkeyName, logger) {
    ...
    const r1cs = await reactNativeR1csfile.readR1csHeader(fdR1cs, sectionsR1cs, false);
